---
layout: post
title: "Weekly reads #9"
date: 2025-05-09
categories: notable-reads
---

**[.. and then one day you became Comfortable Here](https://sashachapin.substack.com/p/and-then-one-day-you-became-comfortable)** — When done for enough time, meditation offers magical moments. And it is strange that our default state is of artificial busy-ness, distraction, and absence. The author captures that profound shift when we stop running from the present and find true peace in witnessing it.

**[Impact, agency, and taste](https://www.benkuhn.net/impact/)** — I slowly came to understand that high value work is very rare. And as a result, we have forgiving protocols that makes it difficult to distinguish between "filler" and "valuable" output. It is our job to assess what's what and try hard to produce meaningful things.
...
**[No one can teach you to have conviction](https://www.benkuhn.net/conviction/)** — The way we become better is through feedback cycles. I see 2 attributes of feedback:
...
**[Research Taste Exercises](https://colah.github.io/notes/taste)** — There are 2 types of skills in technical endeavours:

1. **Taste**: or knowing what to work on.
2. **Execution**: knowing how to implement or build what you have decided on.
...
**[An LLM Codegen Hero's Journey](https://harper.blog/2025/04/17/an-llm-codegen-heros-journey/)** — A comprehensive guide to the progression of AI-assisted coding. From my experience, however, the listed coding assistants are not as good in implementing technical research compared to software engineering. But it still def worth it to try all of them!

**[Tech hiring: is this an inflection point?](https://newsletter.pragmaticengineer.com/p/tech-hiring-is-this-an-inflection)** — Hiring procedures are changing. Worth keeping an eye on!
