...
And in "**[What I’ve Learned from Users](https://www.paulgraham.com/users.html)**":

> I often tell founders to make something they themselves want, and YC is certainly that.

The reason this advice is good (though exceptions exist) is that, by following it, you will have at least **one real user** (yourself) that you can use for feedback to build an [MVP](https://en.wikipedia.org/wiki/Minimum_viable_product), otherwise, you can easily fool yourself into believing what you are building is useful.
...
It's important to be aware of such realities to avoid being [slowly boiled alive](https://en.wikipedia.org/wiki/Boiling_frog).
